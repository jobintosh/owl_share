...
class App extends BaseConfig
{
	 ...
	 * @var string
	 */
	// public $baseURL = 'https://dusit.ac.th/owl_share/public/';
	public $baseURL = 'https://owl.jobintosh.me/';
	 ...
	 * @var boolean
	 */
	//public $cookieSecure = false; //for http
	public $cookieSecure = true; //for https
